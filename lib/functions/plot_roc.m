...
%                 plot(f(:,j,k,i,l,6), r(:,j,k,i,l,6),'--+','Color','#4DBEEE','DisplayName','LOSS','LineWidth',7,'MarkerSize',20);
                plot(f(:,j,k,i,l,7), r(:,j,k,i,l,7),'--x','Color','#0072BD','DisplayName','GLOSS-EE','LineWidth',7,'MarkerSize',20)
%                 plot(f(:,j,k,i,l,8), r(:,j,k,i,l,8),'--x','Color','#EDB120','DisplayName','GLOSS-SVM','LineWidth',7,'MarkerSize',20)
%                 plot(f(:,j,k,i,l,9), r(:,j,k,i,l,9),'--x','Color','#D95319','DisplayName','GLOSS-LOF','LineWidth',7,'MarkerSize',20)
